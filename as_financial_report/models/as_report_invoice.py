...
class AccountInvoiceReport(models.Model):
    ...
    _depends = {
        'product.template': ['as_laboratorio', 'as_laboratorio'],
    }

    def _select(self):
        return super()._select() + ", template.as_laboratorio as as_laboratorio, template.as_line_product as as_line_product "

    def _group_by(self):
        return super()._group_by() + ", template.as_line_product, template.as_laboratorio"
