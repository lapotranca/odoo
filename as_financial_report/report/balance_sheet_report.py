...
class BalanceSheetReport(models.Model):
        ...
        for report in reports:
            ...
            if report.type == 'accounts':
                ...
                query = query + (subquery)
                    ...
                    # left join account_analytic_tag_account_move_line_rel tag_rel on tag_rel.account_move_line = ml.id\
    ...
    def init(self):
        ...
        self.env.cr.execute("""CREATE or REPLACE VIEW %s as ( %s )""" % (self._table, res))
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        for bal in updatable_rec:
            ...
            if bal.get('regiones_id'):
                if compare_sql_string:
                    compare_sql_string += " and "
                compare_sql_string += "regiones_id = " + str(bal['regiones_id'][0])
